...
//dllapi.cpp
int __GetEntityAPI2( DLL_FUNCTIONS *, int *interfaceVersion );
int __GetEntityAPI2_Post( DLL_FUNCTIONS *, int *interfaceVersion );
//engine_api.cpp
int __GetEngineFunctions(enginefuncs_t *, int *interfaceVersion );
int __GetEngineFunctions_Post(enginefuncs_t *, int *interfaceVersion );
...
static META_FUNCTIONS gMetaFunctionTable = 
{
	...
	__GetEntityAPI2,	// pfnGetEntityAPI2			HL SDK2;	called before game DLL
	__GetEntityAPI2_Post,	// pfnGetEntityAPI2_Post		META;		called after game DLL
	NULL,			// pfnGetNewDLLFunctions		HL SDK2;	called before game DLL
	NULL,			// pfnGetNewDLLFunctions_Post		META;		called after game DLL
	__GetEngineFunctions,	// pfnGetEngineFunctions		META;		called before HL engine
	__GetEngineFunctions_Post,// pfnGetEngineFunctions_Post		META;		called after HL	engine
};
